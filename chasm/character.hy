...
Objective should align with the where the plot needs to go, the character's role (less than 8 words). It must give the character urgency and purpose. Either keep it the same or, if it's stale, abandon it for a new mission.
